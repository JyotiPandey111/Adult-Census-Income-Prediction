...
import os
from income.constant  import training_pipeline
...
class DataIngestionConfig:
        '''
        class to assign data ingestion configuration
        '''
...
class DataValidationConfig:
    '''
    class assign data validation configuration
    '''
...
class DataTransformationConfig:
    '''
    Class to assign data transformations configuration 
    '''
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
