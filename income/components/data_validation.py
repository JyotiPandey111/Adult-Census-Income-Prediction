...
# data ingestion artifact also needs to be imported
...
class DataValidation:
    ...
    def __init__(self,data_ingestion_artifact:DataIngestionArtifact,
        ...
        """
        creating data ingestion and validation artifact connfig object
        """
        try:
    ...
    def validate_number_of_columns(self,dataframe:pd.DataFrame)->bool:
        """this function used to vaidate the columsn og datafram

        Returns:
            bool: false if columns are not valid
        """
        try:
    ...
    def is_numerical_column_exist(self,dataframe:pd.DataFrame)->bool:
        ...
        """this function used to vaidate the existence of numerical columns

        Returns: boolean false if numerical columns are present
        """
        try:
